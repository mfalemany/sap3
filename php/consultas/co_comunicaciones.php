...
class co_comunicaciones
{
	...
	/**
	 * A partir de un registro de convocatoria de comunicaciones científicas, extrae los custom_params
	...
	//YA EXISTE OTRA FUNCIÓN MEJORADA: USAR get_comunicaciones_estado_eval EN LUGAR DE ÉSTA
