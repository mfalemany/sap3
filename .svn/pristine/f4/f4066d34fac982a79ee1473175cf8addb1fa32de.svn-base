...
class Reporte_proyecto extends FPDF
{
	...
	function detalles_general($detalles)
	{
		...
		if(isset($detalles['palabras_clave']) && $detalles['palabras_clave']){
			$this->imprimir_titulo_cuadro('Palabras Claves');
			$this->SetFont('arial','',10);
			$this->Cell(190,5,$detalles['palabras_clave'],0,1,'C',false);
			$this->Ln();
		}
		/* ====================== OBJETIVO GENERAL ============================ */
