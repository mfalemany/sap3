...
class ci_becarios_externos extends sap_ci
{
	...
	function evt__guardar()
	{
		try {
			...
			$this->get_datos('pi_inf_becario_ext')->set(array('id_informe'=>$informe['id_informe']));
	...
	{
		$becarios = toba::consulta_php('co_proyectos_informes')->get_becarios_externos('pi',array('id_informe'=>$this->informe_actual['id_informe']));
	...
	function evt__cu_becarios_externos__borrar($seleccion)
	{
		...
		try {
			$this->get_datos()->cargar($seleccion);
			$this->get_datos('pi_inf_becario_ext')->cargar(array('id_informe'=>$this->informe_actual['id_informe']));
