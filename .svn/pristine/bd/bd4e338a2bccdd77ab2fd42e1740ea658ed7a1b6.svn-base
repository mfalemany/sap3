...
class ci_junta_coordinadora extends sap_ci
{
	...
	function conf__pant_edicion(toba_ei_pantalla $pantalla)
	{
		...
		$informacion_interna = json_decode($detalles['postulante']['informacion_interna'], true);
		
		// Si tiene subtipo de beca, obtengo la descripción correspondiente
		$subtipo_beca_desc = !empty($informacion_interna['subtipo_beca']) ? co_becas::SUBTIPOS_BECA[$informacion_interna['subtipo_beca']] : '';
		...
		$datos = array(
			...
			'subtipo_beca_desc'  => sprintf('(%s)', $subtipo_beca_desc),
