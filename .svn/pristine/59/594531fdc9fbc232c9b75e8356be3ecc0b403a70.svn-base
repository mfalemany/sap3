...
class ci_convocatorias extends sap_ci
{
    ...
    function conf__cuadro_convocatorias(sap_ei_cuadro $cuadro)
    {
        ...
        //Se omiten las convocatorias de Comunicaciones Cientìficas y las de Equipos
        //Hay otra operaciòn para administrarlas
        $datos = array_filter($datos, function($convocatoria){
            return !in_array($convocatoria['aplicable'], ['BECARIOS','EQUIPOS']) ;
        });
