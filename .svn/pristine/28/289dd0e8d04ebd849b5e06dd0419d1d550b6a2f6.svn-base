------------------------------------------------------------
--[4562]--  Cumplimiento de Obligaciones - cu_cumplimientos 
------------------------------------------------------------
...
INSERT INTO apex_objeto_eventos (proyecto, evento_id, objeto, identificador, etiqueta, maneja_datos, sobre_fila, confirmacion, estilo, imagen_recurso_origen, imagen, en_botonera, ayuda, orden, ci_predep, implicito, defecto, display_datos_cargados, grupo, accion, accion_imphtml_debug, accion_vinculo_carpeta, accion_vinculo_item, accion_vinculo_objeto, accion_vinculo_popup, accion_vinculo_popup_param, accion_vinculo_target, accion_vinculo_celda, accion_vinculo_servicio, es_seleccion_multiple, es_autovinculo) VALUES (
	...
	'4224', --evento_id
	'4562', --objeto
	'marcar_no_cumplido', --identificador
	'Marcar como NO cumplido', --etiqueta
	'1', --maneja_datos
	'1', --sobre_fila
	'Marcar las obligaciones del mes como NO cumplidas?', --confirmacion
	NULL, --estilo
	'apex', --imagen_recurso_origen
...
INSERT INTO apex_objeto_eventos (proyecto, evento_id, objeto, identificador, etiqueta, maneja_datos, sobre_fila, confirmacion, estilo, imagen_recurso_origen, imagen, en_botonera, ayuda, orden, ci_predep, implicito, defecto, display_datos_cargados, grupo, accion, accion_imphtml_debug, accion_vinculo_carpeta, accion_vinculo_item, accion_vinculo_objeto, accion_vinculo_popup, accion_vinculo_popup_param, accion_vinculo_target, accion_vinculo_celda, accion_vinculo_servicio, es_seleccion_multiple, es_autovinculo) VALUES (
	...
	'4242', --evento_id
	'4562', --objeto
	'eliminar_cumplimiento', --identificador
	NULL, --etiqueta
	'1', --maneja_datos
	'1', --sobre_fila
	'Si existe, se eliminará el cumplimiento del becario. Continuar y eliminar?', --confirmacion
	NULL, --estilo
	'apex', --imagen_recurso_origen
	'borrar.gif', --imagen
	'0', --en_botonera
