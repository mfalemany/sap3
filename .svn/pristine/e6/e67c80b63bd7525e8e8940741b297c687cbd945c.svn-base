  ...
  ADD COLUMN estado_aval boolean DEFAULT NULL;*/
	...
	function evt__cu_avales__avalar($seleccion)
	{
		try {
			...
			toba::notificacion()->info('Se ha registrado su aval para la comunicación.');
		} catch (toba_error_db $e) {
			toba::notificacion()->error('Ocurrió un error al otorgar el aval');
		}
	...
	function servicio__imprimir()
	{
		...
		if( ! $params['id']) throw new toba_error('No se recibió como parámetro la comunicación que intenta imprimir');
