...
<div id="contenedor_admisibilidad">
	...
	<div id="direccion" class="seccion">
		<div class="titulo_seccion">Dirección</div>
		<table>
	...
	<div id="detalles">
		<div id="documentacion" class="seccion">
			<div class="titulo_seccion">Documentación</div>
			...
			if(file_exists($ruta.$ubicacion)) : ?>
				<a class="" href="<?php echo $url.$ubicacion; ?>" target="_BLANK">Título de Grado</a>
			<?php endif; ?>
			...
			if(file_exists($ruta.$ubicacion)) : ?>
			<a class="" href="<?php echo $url.$ubicacion; ?>" target="_BLANK">Analítico</a>
			<?php endif; ?>
		...
		<div id="controles"  class="seccion">
			...
			<p>
				Edad: <?php echo $edad_asp; ?> años.
			</p>
			<p class=<?php echo ( ! $ctrl_admisibilidad['mayor_dedicacion']) ? 'fallo' : '';?>>Mayor Dedicación</p>
			<p class=<?php echo ( ! $ctrl_admisibilidad['grado_categoria'])  ? 'fallo' : '';?>>Grado/Categoría</p>

			<?php if($detalles_tipo_beca['requiere_insc_posgrado'] == 'S') : ?>
				<p class="<?php echo ( ! file_exists($ruta.$ubic_posgr)) ? 'fallo' : '';  ?>">
					Inscripción o compromiso a un posgrado
				</p>
			<?php endif; ?>
			...
			<p class=<?php echo ( ! $avales['aval_secretaria'])   ? 'fallo' : '';?>>Aval Secretaría Investigación</p>
	...
	<?php 
		$cats  = array(1=>'Categoría I',2=>'Categoría II',3=>'Categoría III');
	...
	?>
	<div class="seccion">
		<div class="titulo_seccion">Director de la beca: Calificación Transitoria de Incentivos</div>
		<?php if ($datos['solic_trans_inc_dir']) : ?>
			<div class="categoria_solicitada">Categoría solicitada: <?php echo $cats[$datos['solic_trans_inc_dir']['categoria']]; ?></div>
	...
	<div class="seccion">
		<div class="titulo_seccion">Co-Director de la beca: Calificación Transitoria de Incentivos</div>
		<?php if ($datos['solic_trans_inc_codir']) : ?>
			<div class="categoria_solicitada">Categoría solicitada: <?php echo $cats[$datos['solic_trans_inc_codir']['categoria']]; ?></div>
			<table class="tabla_solic_trans_inc_dir">
	...
	<div class="seccion">
		<div class="titulo_seccion">Sub-Director de la beca: Calificación Transitoria de Incentivos</div>
		<?php if ($datos['solic_trans_inc_subdir']) : ?>
			<div class="categoria_solicitada">Categoría solicitada: <?php echo $cats[$datos['solic_trans_inc_subdir']['categoria']]; ?></div>
			<table class="tabla_solic_trans_inc_dir">
