------------------------------------------------------------
--[4477]--  Mis Proyectos - ci_detalles_proyecto - form_detalles_pdts 
------------------------------------------------------------
...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, punto_montaje, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'Mis Proyectos - ci_detalles_proyecto - form_detalles_pdts', --nombre
	'Detalles del PDTS', --titulo
	'0', --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_ut_formulario (objeto_ut_formulario_proyecto, objeto_ut_formulario, tabla, titulo, ev_agregar, ev_agregar_etiq, ev_mod_modificar, ev_mod_modificar_etiq, ev_mod_eliminar, ev_mod_eliminar_etiq, ev_mod_limpiar, ev_mod_limpiar_etiq, ev_mod_clave, clase_proyecto, clase, auto_reset, ancho, ancho_etiqueta, expandir_descripcion, campo_bl, scroll, filas, filas_agregar, filas_agregar_online, filas_agregar_abajo, filas_agregar_texto, filas_borrar_en_linea, filas_undo, filas_ordenar, filas_ordenar_en_linea, columna_orden, filas_numerar, ev_seleccion, alto, analisis_cambios, no_imprimir_efs_sin_estado, resaltar_efs_con_estado, template, template_impresion) VALUES (
	...
	<tbody>
		<tr>
			<td>
				<p class="aclaracion_form">Describir los resultados que se esperan conseguir: productos, procesos, prospectivas o propuestas</p>[ef id=producto]</td>
		</tr>
		<tr>
			<td>
				<p class="aclaracion_form">Describir las innovaciones cognitivas que se implementar&aacute;n en el proyecto. Describir de que forma el desarrollo implica una &#39;novedad local&#39;</p>[ef id=originalidad]</td>
		</tr>
		<tr>
			<td>
				<p class="aclaracion_form">Describir la adecuaci&oacute;n de los objetivos del proyecto a pol&iacute;ticas p&uacute;blicas y objetivos de pol&iacute;tica de sectores de la sociedad civil o a valores mas o menos generalizados en la sociedad.</p>[ef id=relevancia]</td>
		</tr>
		<tr>
			<td>
				<p class="aclaracion_form">Describir de que forma se considera apropiada la estrategia del PDTS en t&eacute;rminos de su capacidad para resolver el problema identificado y la adecuaci&oacute;n de los resultados esperados al uso concreto en el contexto local de aplicaci&oacute;n.</p>[ef id=pertinencia]</td>
		</tr>
		<tr>
			<td>
				<p class="aclaracion_form">Describir la problem&aacute;tica, inter&eacute;s y aplicabilidad manifestada por los demandantes y posibles adoptantes en el desarrollo propuesto. Incorporar la manifestaci&oacute;n del inter&eacute;s del adoptante.</p>[ef id=demanda]</td>
		</tr>
	</tbody>
</table>
<p>&nbsp;</p>', --template
